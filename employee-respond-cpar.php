                                 ...
                                 <div class="mdl-grid">
                                    ...
                                    <div class="mdl-cell mdl-cell--1-col"></div>
                                     <div class="mdl-cell mdl-cell--5-col">
                                         <label>Issuer Name</label><input type="text" name="issuer_name" class="field-divided" placeholder="Issuer Name" disabled value="<?php echo $issr_nm;?>" style="width: 100%; font-family: Lucida Sans Unicode" />
<!--
...
-->
                                     ...
                                     <div class="mdl-cell mdl-cell--1-col"></div>
                                     <div class="mdl-cell mdl-cell--5-col">
                                         <label>Issuer Dep’t./Crewing Office</label><input type="text" name="issuer_dprtmnt" class="field-divided" placeholder="Issuer Dep’t./Crewing Office" disabled value="<?php  echo $issr_dprtmnt;?>" style="width: 100%; font-family: Lucida Sans Unicode" />
<!--
                                          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%">
...
-->
                                    ...
                                    <div class="mdl-cell mdl-cell--1-col"></div>
                                     <div class="mdl-cell mdl-cell--5-col">
                                         <label>Issue To (Name)</label><input type="text" name="issuer_dprtmnt" class="field-divided" placeholder="Issue To (Name)" disabled value="<?php echo $cncrn_nm;?>" style="width: 100%; font-family: Lucida Sans Unicode" />
<!--
                                       <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%">
...
-->
                                     ...
                                     <div class="mdl-cell mdl-cell--1-col"></div>
                                     <div class="mdl-cell mdl-cell--5-col">
                                          <label>Issue To (Department)</label><input type="text" name="issuer_dprtmnt" class="field-divided" placeholder="Issue To (Department)" disabled value="<?php echo $cncrn_dprtmnt;?>" style="width: 100%; font-family: Lucida Sans Unicode" />
<!--
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%">
...
-->
                                     ...
                                     <div class="mdl-cell mdl-cell--1-col"></div>
                                     <div class="mdl-cell mdl-cell--5-col">
                                          <label>Issuer Superior Email Address</label><input type="text" name="issuer_dprtmnt" class="field-divided" placeholder="Issuer Superior Email Address" disabled value="<?php echo $spr_eml;?>" style="width: 100%; font-family: Lucida Sans Unicode"/>
<!--
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width: 100%">

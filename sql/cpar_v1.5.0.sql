...
CREATE TABLE `iss_cncrn` (
  ...
  `ISS_CPR_NMBR` varchar(255) DEFAULT NULL,
  `ISS_RT_CSE` longtext,
  `ISS_CRRCTN` longtext,
  `ISS_CRRCTN_ACTN` longtext,
  `ISS_CPR_DT` date DEFAULT NULL,
  `ISS_CNCRN_CMPLTN_DT` date DEFAULT NULL,
  `ISS_CNCRN_APPRVL_STS` varchar(50) DEFAULT NULL,
  `ISS_CNCRN_VLDT_STS` varchar(50) DEFAULT NULL,
  `ISS_CNCRN_RSN_FR_DNL` longtext,
...
INSERT INTO `iss_cncrn` VALUES (14,'CS-1704-LS01','asd','asd','asd','2017-04-23','2017-04-28','','VALIDATE',NULL,1);
...
INSERT INTO `ntfctn` VALUES (4,'New cpar issue has been sent to you by superior issuer, Echo Foxtrot, to be answered.','Read',4,'2017-04-23','01:56:45'),(7,'New cpar issue has been sent to you by issuer, Charlie Delta, to be validated.','Read',2,'2017-04-23','11:05:22'),(8,'cpar issue has been rejected by Issuer Superior, , with the reason of rejection of: asdsad.','Read',1,'2017-04-23','11:06:04'),(9,'New cpar issue has been sent to you by issuer, Charlie Delta, to be validated.','Read',2,'2017-04-23','11:09:54'),(10,'Your CPAR issue has been rejected by Issuer Superior, Echo Foxtrot, with the reason of rejection of: Nope.','Read',1,'2017-04-23','11:17:59'),(11,'CPAR issue has been sent to you by Employee, Golf Hotel, to be validated.','Read',2,'2017-04-28','14:15:57'),(12,'CPAR issue has been sent to you by Employee, Golf Hotel, to be validated.','Read',2,'2017-04-28','14:21:54'),(13,'CPAR issue has been sent to you by Employee, Golf Hotel, to be validated.','Read',2,'2017-04-28','14:27:21'),(14,'CPAR issue has been sent to you by Employee, Golf Hotel, to be validated.','Read',2,'2017-04-28','14:43:01');
...
-- Dump completed on 2017-04-28 14:50:39

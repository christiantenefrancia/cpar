...
INSERT INTO `iss` VALUES (1,'Request for Disposition/Inaction','Observation','description of finding','Approved','VALIDATED',NULL,'2017-04-28','16:59:31',1,2,5,1,'2017-04-28','2017-04-28');
...
CREATE TABLE `iss_cncrn` (
  ...
  `ISS_CNCRN_DT_APPRVD` date DEFAULT NULL,
...
INSERT INTO `iss_cncrn` VALUES (1,'RD-1704-RT01','root cause','correction','correction action','2017-04-28','2017-04-28',NULL,'','VALIDATE',NULL,1);
...
INSERT INTO `ntfctn` VALUES (1,'New cpar issue has been sent to you by issuer, Charlie Delta, to be validated.','Unread',2,'2017-04-28','16:59:32'),(2,'cpar issue has been approved by Issuer Superior, Echo Foxtrot, to be answered.','Read',5,'2017-04-28','17:00:03'),(3,'cpar issue has been approved by Issuer Superior, Echo Foxtrot, to be answered.','Read',5,'2017-04-28','17:00:35'),(4,'CPAR issue has been sent to you by Employee, India Juliet, to be validated.','Unread',2,'2017-04-28','17:02:28');
...
-- Dump completed on 2017-04-28 17:10:48

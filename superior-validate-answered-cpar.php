...
-->												<input type="hidden" name="issue_to_validate" value="<?php echo $_GET['issue_id_to_validate'];?>">
												<input type="hidden" name="issue_concern_to_validate" value="<?php echo $_GET['issue_concern_id_to_validate'];?>">
                                                ...
                                                <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" style="width: 100%" name="proceed" type="submit">

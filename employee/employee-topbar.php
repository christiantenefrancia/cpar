...
-->
        ...
        <div class="android-navigation-container">
             <div class="android-navigation mdl-navigation" style="width: 83.3%;">
...
-->
          ...
          <ul class="mdl-menu mdl-js-menu mdl-menu--bottom-right mdl-js-ripple-effect" for="more-button">
            <a style="text-decoration: none" href="<?php echo HTTP_ROOT;?>employee.php?logout"><li class="mdl-menu__item">Logout</li></a>
...
-->
          <a class="mdl-navigation__link" href="<?php echo HTTP_ROOT;?>employee.php?logout">
